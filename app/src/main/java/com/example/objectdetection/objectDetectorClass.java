      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Imgproc.rectangle(rotated_mat_image,new Point(left,top),new Point(right,bottom),new Scalar(250, 0, 0, 1),2);
                // write text on frame   // string of class name of object  // starting point                         // color of text           // size of text
                Imgproc.putText(rotated_mat_image,labelList.get((int) class_value),new Point(left,top),2,1,new Scalar(250, 0, 0, 1),1 ) ;
            }
